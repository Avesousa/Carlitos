<?php
    ...
    $update = $con->query("UPDATE enviodomicilio SET telefono = $telefono, direccion = '$direccion', pedido = '$pedido' WHERE id = $id");
    $mensaje = "¡Se ha actualizado el pedido, con éxito!";
    if(!$update){
