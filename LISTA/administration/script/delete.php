<?php
    ...
    $update = $con->query("UPDATE enviodomicilio SET disponible = 0 WHERE id = $id");
    $mensaje = "¡Se ha eliminado el pedido, con éxito!";
    if(!$update){
        $mensaje = "ERROR DE CONEXIÓN Y NO SE BORRO ".$con->error;
    }
?>
<!DOCTYPE html>
<html lang="es">
